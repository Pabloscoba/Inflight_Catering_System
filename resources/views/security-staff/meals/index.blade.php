...
@section('title', 'Authenticate Meals')

@section('content')
<div class="content-header">
    <div>
        <h1>Meals Awaiting Authentication</h1>
        <p>Authenticate approved meals before dispatch</p>
    </div>
</div>
...
@if($meals->isEmpty())
    <div style="background:white;border-radius:16px;padding:48px;text-align:center;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <h3 style="color:#374151;margin-bottom:8px;">No Meals Awaiting Authentication</h3>
        <p style="color:#6b7280;">All approved meals have been authenticated.</p>
    </div>
@else
        ...
        <table style="width:100%;border-collapse:collapse;">
            <thead style="background:#f9fafb;border-bottom:2px solid #e5e7eb;">
                <tr>
                    ...
                    <th style="padding:16px;text-align:left;font-weight:600;color:#374151;">Approved By</th>
                    <th style="padding:16px;text-align:left;font-weight:600;color:#374151;">Approved Date</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f3f4f6;">
                    ...
                    <td style="padding:16px;color:#374151;">{{ $meal->approvedBy->name ?? 'N/A' }}</td>
                    <td style="padding:16px;color:#374151;">{{ $meal->approved_at ? $meal->approved_at->format('M d, Y H:i') : 'N/A' }}</td>
                    <td style="padding:16px;text-align:center;">
                        <a href="{{ route('security-staff.meals.show', $meal) }}" 
