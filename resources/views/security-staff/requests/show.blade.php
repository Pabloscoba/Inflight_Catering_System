...
<div style="background:white;border-radius:16px;padding:28px;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
    ...
    <button type="button" onclick="showAuthenticateConfirmation({{ $request->id }}, {{ $request->items->sum('quantity_requested') }})" style="background:linear-gradient(135deg,#10b981 0%,#1e3a8a 100%);color:white;padding:14px 32px;border-radius:8px;border:none;font-size:15px;font-weight:700;display:inline-flex;align-items:center;gap:10px;cursor:pointer;box-shadow:0 4px 12px rgba(16,185,129,0.25);transition:all 0.2s;" onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 6px 16px rgba(16,185,129,0.35)'" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 4px 12px rgba(16,185,129,0.25)'">
...
function showAuthenticateConfirmation(requestId, totalUnits) {
    ...
    confirmDiv.innerHTML = `
        ...
        <div style="display:flex;gap:12px;justify-content:flex-end;">
            ...
            <button onclick="submitAuthForm(${requestId})" style="background:linear-gradient(135deg,#10b981 0%,#1e3a8a 100%);color:white;border:none;padding:10px 20px;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;">✓ Authenticate</button>
        </div>
    `;
