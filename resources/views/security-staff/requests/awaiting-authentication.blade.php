...
@if(session('success'))
<div style="background:#d1fae5;border-left:4px solid #1e3a8a;padding:16px 20px;border-radius:8px;margin-bottom:24px;color:#065f46;font-weight:600;">
