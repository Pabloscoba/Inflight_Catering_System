...
@section('title', 'Load Meals into Flight')

@section('content')
<div class="content-header">
    <div>
        <h1>Meals Ready for Loading</h1>
        <p>Load authenticated meals onto the aircraft</p>
    </div>
</div>
...
@if($meals->isEmpty())
    <div style="background:white;border-radius:16px;padding:48px;text-align:center;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <h3 style="color:#374151;margin-bottom:8px;">No Meals Ready for Loading</h3>
        <p style="color:#6b7280;">All dispatched meals have been loaded.</p>
    </div>
@else
    <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        <table style="width:100%;border-collapse:collapse;">
            <thead style="background:#f9fafb;border-bottom:2px solid #e5e7eb;">
                <tr>
                    <th style="padding:16px;text-align:left;font-weight:600;color:#374151;">Meal</th>
                    ...
                    <th style="padding:16px;text-align:left;font-weight:600;color:#374151;">Dispatched By</th>
                    <th style="padding:16px;text-align:left;font-weight:600;color:#374151;">Dispatch Date</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f3f4f6;">
                    ...
                    <td style="padding:16px;color:#374151;">{{ $meal->route ?? 'Any Route' }}</td>
                    <td style="padding:16px;color:#374151;">{{ $meal->dispatchedBy->name ?? 'N/A' }}</td>
                    <td style="padding:16px;color:#374151;">{{ $meal->dispatched_at ? $meal->dispatched_at->format('M d, Y H:i') : 'N/A' }}</td>
                    <td style="padding:16px;text-align:center;">
                        <a href="{{ route('flight-purser.meals.show', $meal) }}" 
