    ...
    <body>
        <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                <h2 style="font-size: 24px; font-weight: 700; color: #111827; margin: 0;">Users List</h2>
                <a href="{{ route('admin.users.create') }}" class="btn-atcl btn-atcl-primary">
            ...
            <div class="card-atcl" style="padding: 20px; margin-bottom: 24px;">
                <form action="{{ route('admin.users.index') }}" method="GET"
                    ...
                    <div>
                        <label class="label-atcl">Role</label>
                        <select name="role" class="input-atcl">
                    ...
                    <div style="display: flex; gap: 8px;">
                        <button type="submit" class="btn-atcl btn-atcl-primary" style="flex: 1;">
                            Filter
                        </button>
                        <a href="{{ route('admin.users.index') }}" class="btn-atcl btn-atcl-secondary"
            ...
            <div class="card-atcl" style="padding: 0; overflow: hidden;">
                                            ...
                                            <div class="actions">
                                                ...
                                                @if($user->id !== auth()->id())
                                                    <form method="POST" action="{{ route('admin.users.toggle-status', $user) }}"
                                                        ...
                                                        @method('PATCH')
                                                        <button type="submit"
                                                            class="btn btn-sm {{ $user->is_active ? 'btn-secondary' : 'btn-primary' }}">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <p>No users found.
                            {{ request('search') || request('role') ? 'Try adjusting your filters.' : 'Create your first user!' }}
                        </p>
                    </div>
                @endif
            </div>
