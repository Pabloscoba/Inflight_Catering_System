...
<form action="{{ route('catering-staff.meals.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div style="background:white;border-radius:16px;padding:28px;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:24px;">
        ...
        <div>
            <label style="display:block;font-weight:600;margin-bottom:8px;color:#374151;">Meal Photo</label>
    ...
    <div style="background:white;border-radius:16px;padding:28px;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:24px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:20px;">
            <div>
                ...
                <input type="text" name="portion_size" value="{{ old('portion_size') }}" 
                       style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:8px;font-size:14px;"
            ...
            <div>
                ...
                <input type="text" name="nutritional_info" value="{{ old('nutritional_info') }}" 
                       style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:8px;font-size:14px;"
    ...
    <div style="background:white;border-radius:16px;padding:28px;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:24px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px;margin-bottom:20px;">
            <div>
                ...
                <input type="text" name="season" value="{{ old('season') }}" 
                       style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:8px;font-size:14px;"
            ...
            <div>
                ...
                <input type="text" name="menu_version" value="{{ old('menu_version') }}" 
                       style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:8px;font-size:14px;"
        ...
        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:20px;">
            ...
            <div>
                ...
                <input type="date" name="effective_end_date" value="{{ old('effective_end_date') }}" 
                       style="width:100%;padding:12px;border:1px solid #e5e7eb;border-radius:8px;font-size:14px;">
    ...
    <div style="display:flex;gap:12px;justify-content:flex-end;">
        ...
        <button type="submit" 
                style="background:linear-gradient(135deg,#10b981 0%,#059669 100%);color:white;border:none;padding:12px 32px;border-radius:8px;font-weight:600;cursor:pointer;">
            ✓ Create Meal
        </button>
    </div>
</form>
