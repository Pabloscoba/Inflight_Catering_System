...
@if(session('success'))
            ...
            <div class="action-buttons">
                <a href="{{ route('inventory-personnel.stock-movements.incoming') }}" class="btn btn-success">+ Incoming Stock</a>
                <a href="{{ route('inventory-personnel.stock-movements.issue') }}" class="btn btn-warning">↗ Issue Stock</a>
                <a href="{{ route('inventory-personnel.stock-movements.returns') }}" class="btn btn-info">↩ Returns</a>
            </div>
