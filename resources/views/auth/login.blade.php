...
<head>
    ...
    <title>{{ config('app.name', 'Inflight Catering System') }} - Login</title>
    ...
    <div class="min-h-screen flex items-center justify-center aircraft-bg relative">
        ...
        <div class="relative z-10 w-full max-w-md px-6 fade-in-up">
            ...
            <div class="text-center mb-8">
                ...
                <h1 style="font-style: sans-serif;" class="text-xl font-semibold text-blue-100 mb-2">Air Tanzania</h1>
            ...
            <div class="glass-card rounded-2xl p-8 shadow-2xl">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <!-- Email Address -->
                    <div class="mb-5">
                        <label for="email" class="block text-sm font-semibold text-gray-50 mb-2">
                            Email Address
                        </label>
                        <div class="relative">
                    ...
                    <!-- Password -->
                    <div class="mb-5">
                        <label for="password" class="block text-sm font-semibold text-gray-50 mb-2">
                            Password
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}"
                                class="text-sm font-medium text-blue-200 hover:text-white hover:underline">
                                Forgot password?
                            </a>
                        @endif
                    </div>
                    ...
                    <!-- Login Button -->
                    <button type="submit"
                        class="btn-primary w-full py-3 px-4 rounded-lg font-semibold shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2">
