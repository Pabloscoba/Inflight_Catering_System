                        ...
                        <td style="padding: 14px;">
                            <div style="display: flex; gap: 8px;">
                                <form action="{{ route('catering-incharge.requests.approve', $request) }}" method="POST" style="margin: 0;">
                                    @csrf
                                    <button type="submit" onclick="return confirm('Approve this request?\n\nThis will:\n✓ Allocate stock to Catering Staff\n✓ Deduct from catering inventory\n✓ Cannot be undone')" style="background: #28a745; color: white; border: none; padding: 6px 16px; border-radius: 6px; font-size: 13px; font-weight: 600; cursor: pointer; transition: all 0.2s;" onmouseover="this.style.background='#218838'" onmouseout="this.style.background='#28a745'">
                                        ✓ Approve
                                    </button>
                                </form>
