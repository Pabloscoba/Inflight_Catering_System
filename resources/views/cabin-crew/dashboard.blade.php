...
<div class="content-header">
    ...
    <p>Receive catering supplies from Flight Purser and mark as delivered</p>
</div>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:24px;margin-bottom:32px;">
    ...
    <div style="background:white;border-radius:16px;padding:24px;box-shadow:0 2px 8px rgba(0,0,0,0.08);display:flex;gap:20px;align-items:center;">
        ...
        <div style="flex:1;">
            ...
            <div style="font-size:14px;color:#718096;margin-top:4px;">To Receive</div>
        </div>
    </div>
    ...
    <div style="background:white;border-radius:16px;padding:24px;box-shadow:0 2px 8px rgba(0,0,0,0.08);display:flex;gap:20px;align-items:center;">
        ...
        <div style="flex:1;">
            <div style="font-size:32px;font-weight:700;color:#1a202c;line-height:1;">{{ $deliveredRequests }}</div>
            <div style="font-size:14px;color:#718096;margin-top:4px;">Delivered</div>
        </div>
    </div>
    ...
    <div style="background:white;border-radius:16px;padding:24px;box-shadow:0 2px 8px rgba(0,0,0,0.08);display:flex;gap:20px;align-items:center;">
        ...
        <div style="flex:1;">
            <div style="font-size:32px;font-weight:700;color:#1a202c;line-height:1;">{{ $totalFlights }}</div>
            <div style="font-size:14px;color:#718096;margin-top:4px;">Flights Handled</div>
        </div>
    </div>
</div>
...
<div style="background:white;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,0.08);margin-bottom:28px;">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        <div>
            <h2 style="font-size:20px;font-weight:700;color:#1a202c;margin:0;">🎯 Requests Loaded from Flight Purser</h2>
            <p style="color:#718096;font-size:14px;margin:4px 0 0 0;">Ready to receive and mark as delivered</p>
        </div>
                ...
                <tr style="border-bottom:1px solid #e2e8f0;transition:background 0.2s;" onmouseover="this.style.background='#f7fafc'" onmouseout="this.style.background='white'">
                    ...
                    <td style="padding:16px;text-align:center;">
                        <div style="display:flex;gap:8px;justify-content:center;">
                            <a href="{{ route('cabin-crew.products.view', $request) }}" style="background:#38a169;color:white;border:none;padding:8px 16px;border-radius:8px;font-weight:600;font-size:13px;text-decoration:none;display:inline-block;">
                                📦 View Products
                            </a>
                            <form action="{{ route('cabin-crew.requests.deliver', $request) }}" method="POST" style="display:inline;">
                                @csrf
                                <button type="submit" style="background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:white;border:none;padding:8px 20px;border-radius:8px;font-weight:600;font-size:13px;cursor:pointer;transition:transform 0.2s,box-shadow 0.2s;" onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 4px 12px rgba(102,126,234,0.4)'" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='none'">
                                    ✅ Deliver
                                </button>
                            </form>
                        </div>
...
<div style="background:white;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,0.08);margin-bottom:28px;">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        <div>
            ...
            <p style="color:#718096;font-size:14px;margin:4px 0 0 0;">Delivery history</p>
        </div>
    </div>
