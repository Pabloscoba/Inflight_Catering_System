...
Route::middleware(['auth', 'role:Admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/requests/pending', [App\Http\Controllers\Admin\RequestController::class, 'pending'])->name('requests.pending');
    Route::get('/requests/approved', [App\Http\Controllers\Admin\RequestController::class, 'approved'])->name('requests.approved');
    Route::get('/requests/rejected', [App\Http\Controllers\Admin\RequestController::class, 'rejected'])->name('requests.rejected');
...
Route::middleware(['auth', 'role:Inventory Supervisor'])->prefix('inventory-supervisor')->name('inventory-supervisor.')->group(function () {
    ...
    Route::get('/requests/pending', [App\Http\Controllers\Admin\RequestController::class, 'pending'])->name('requests.pending')->middleware('permission:approve requests');
    Route::get('/requests/{request}/approve', [App\Http\Controllers\Admin\RequestController::class, 'approveForm'])->name('requests.approve-form')->middleware('permission:approve requests');
    Route::post('/requests/{request}/approve', [App\Http\Controllers\Admin\RequestController::class, 'approve'])->name('requests.approve')->middleware('permission:approve requests');
